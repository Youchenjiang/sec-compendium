...
- [**`UNIFIED_FREE_CHALLENGES_INDEX.md`**](UNIFIED_FREE_CHALLENGES_INDEX.md)：**全域免費實戰題庫導航中心**。聚合 CyberDefenders (82 題)、Hack The Box (359 題)、MTA (113 套)、PortSwigger (274 題)、picoCTF/CyLab (525 題)、CryptoHack (308 題)、TryHackMe (992 間房間) 與 Root-Me (212 題) 八大主流平台免付費實作資源，共收錄逾 2,860 道免費實戰題目。
...
| 目錄 / 文件 | 類型 | 說明 |
|---|---|---|
| [**`UNIFIED_FREE_CHALLENGES_INDEX.md`**](UNIFIED_FREE_CHALLENGES_INDEX.md) | 🌐 全平台聚合 | 八大平台完全免費題庫大導航與跨領域攻防映射（共 2,860+ 道已驗證免付費題目） |
...
| [**`platforms/rootme/`**](platforms/rootme/) | 🚩 經典全領域攻防 | Root-Me 官方即時 212 道全領域免費挑戰（Web、系統、密碼、取證）目錄與 CSV |
